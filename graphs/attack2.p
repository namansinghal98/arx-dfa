...
#unset key
set title "Fault Attack Results on SIMON N=48,64"
set key right top
...
#set origin 0,0
plot 'attack2faults.dat' using 2:xticlabels(1) with linespoints linestyle 1 notitle axis x1y1, \
     ...
     'attack2succ.dat'   using 2:xticlabels(1) with linespoints linestyle 6 notitle axis x1y2, \
    ''              using 3:xticlabels(1) with linespoints linestyle 7 notitle axis x1y2, \
     ...
     "+"  u 1:(NaN)  with line lc rgb '#0060ad' t 'SIMON(96/96)', \
     "+"  u 1:(NaN)  with line lc rgb '#dd181f' t 'SIMON(96/144)', \
     "+"  u 1:(NaN)  with line lc rgb '#DAA520' t 'SIMON(128/128)', \
     "+"  u 1:(NaN)  with line lc rgb '#228B22' t 'SIMON(128/192)', \
     "+"  u 1:(NaN)  with line lc rgb '#8B008B' t 'SIMON(128/256)', \
